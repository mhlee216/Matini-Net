...
parser.add_argument('--case', type=str, default='direct_cgcnn')
...
# SHAP
print('SHAP')
best_nn.feature_nn.data_feat = True
train_x_list = mipc.shap_tensor(best_nn.graph_nn, best_nn.feature_nn, train_data, args.device)
valid_x_list = mipc.shap_tensor(best_nn.graph_nn, best_nn.feature_nn, valid_data, args.device)
shap_values = mipc.shap_explainer(best_nn.pred_nn, train_x_list, valid_x_list)
